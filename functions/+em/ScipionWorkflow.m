...
classdef ScipionWorkflow < em.PackageInterface
    ...
    methods
        function obj = ScipionWorkflow( ...
            scipionSource, projectName, pairedAnalysis, pathToRefMontage, varargin ...
        )
            ...
            parse(p,scipionSource, projectName, pairedAnalysis, pathToRefMontage, ...
                  varargin{:});
    ...
    methods (Access = private)
        ...
        function launchDockerWorkflow(obj)
            ...
            try
                ...
                cmd = strcat(obj.spartanEnv.dockerPath, ...
                             {' volume rm '}, ...
                             obj.DOCKER_INPUT_VOLUME);
                cmd = cmd{1};
                system(cmd);
                ...
                cmd = strcat(obj.spartanEnv.dockerPath, ...
                             {' container create --name dummy -v '}, ...
                             obj.DOCKER_INPUT_VOLUME, ...
                             {':/home/scipion/inputs hello-world'});
                cmd = cmd{1};
                ...
                cmd = [obj.spartanEnv.dockerPath ' container rm dummy'];
            ...
            cmd = [obj.spartanEnv.dockerPath ...
                   ...
                   '    --mount source=ScipionInputData,target=/home/scipion/inputs ' ...
                   '    -e DISPLAY=' ...
                   obj.spartanEnv.dockerDisplayServer ...
                   '    -v /tmp/.X11-unix:/tmp/.X11-unix ' ...
                   '    epflbiophys/scipion:1.2'];
