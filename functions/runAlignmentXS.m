function [aligniter,iterIm,s,n_frame,allIm,data,images0] = runAlignment(MList,data0,imsize,zoomfactor, pixelsize, photonpercount,usfac,angrange,angstep,n_iteration);
